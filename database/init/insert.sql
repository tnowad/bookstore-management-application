...
VALUES
    (1, 'admin', 'admin123', 'active', 'Nguyễn Văn A', 'admin@example.com', '0987654321', NOW(), NOW(), 'admin'),
    (2, 'employee1', 'password1', 'active', 'Nguyễn Thị B', 'employee1@example.com', '0912345678', NOW(), NOW(), 'employee'),
    (3, 'employee2', 'password2', 'active', 'Trần Văn C', 'employee2@example.com', '0923456789', NOW(), NOW(), 'employee'),
    (4, 'employee3', 'password3', 'active', 'Lê Thị D', 'employee3@example.com', '0934567890', NOW(), NOW(), 'employee'),
    (5, 'employee4', 'password4', 'active', 'Phạm Văn E', 'employee4@example.com', '0945678901', NOW(), NOW(), 'employee'),
    (6, 'employee5', 'password5', 'active', 'Đỗ Thị F', 'employee5@example.com', '0956789012', NOW(), NOW(), 'employee'),
    (7, 'employee6', 'password6', 'active', 'Võ Văn G', 'employee6@example.com', '0967890123', NOW(), NOW(), 'employee'),
    (8, 'employee7', 'password7', 'active', 'Bùi Thị H', 'employee7@example.com', '0978901234', NOW(), NOW(), 'employee'),
    (9, 'employee8', 'password8', 'active', 'Hồ Văn I', 'employee8@example.com', '0989012345', NOW(), NOW(), 'employee'),
    (10, 'employee9', 'password9', 'active', 'Nguyễn Thị K', 'employee9@example.com', '0990123456', NOW(), NOW(), 'employee'),
    (11, 'user11', 'password11', 1, 'Nguyễn Văn A', 'user11@example.com', '0987654321', NOW(), NOW(), 'customer'),
    (12, 'user12', 'password12', 1, 'Nguyễn Văn B', 'user12@example.com', '0987654322', NOW(), NOW(), 'customer'),
    (13, 'user13', 'password13', 1, 'Nguyễn Văn C', 'user13@example.com', '0987654323', NOW(), NOW(), 'customer'),
    (14, 'user14', 'password14', 1, 'Nguyễn Văn D', 'user14@example.com', '0987654324', NOW(), NOW(), 'customer'),
    (15, 'user15', 'password15', 1, 'Nguyễn Văn E', 'user15@example.com', '0987654325', NOW(), NOW(), 'customer'),
    (16, 'user16', 'password16', 1, 'Nguyễn Văn F', 'user16@example.com', '0987654326', NOW(), NOW(), 'customer'),
    (17, 'user17', 'password17', 1, 'Nguyễn Văn G', 'user17@example.com', '0987654327', NOW(), NOW(), 'customer'),
    (18, 'user18', 'password18', 1, 'Nguyễn Văn H', 'user18@example.com', '0987654328', NOW(), NOW(), 'customer'),
    (19, 'user19', 'password19', 1, 'Nguyễn Văn I', 'user19@example.com', '0987654329', NOW(), NOW(), 'customer'),
    (20, 'user20', 'password20', 1, 'Nguyễn Văn K', 'user20@example.com', '0987654330', NOW(), NOW(), 'customer'),
    (21, 'user21', 'password21', 1, 'Nguyễn Văn L', 'user21@example.com', '0987654331', NOW(), NOW(), 'customer'),
    (22, 'user22', 'password22', 1, 'Nguyễn Văn M', 'user22@example.com', '0987654332', NOW(), NOW(), 'customer'),
    (23, 'user23', 'password23', 1, 'Nguyễn Văn N', 'user23@example.com', '0987654333', NOW(), NOW(), 'customer'),
    (24, 'user24', 'password24', 1, 'Nguyễn Văn O', 'user24@example.com', '0987654334', NOW(), NOW(), 'customer'),
    (25, 'user25', 'password25', 1, 'Nguyễn Văn P', 'user25@example.com', '0987654335', NOW(), NOW(), 'customer'),
    (26, 'employee26', 'password26', 'active', 'Nguyễn Văn Tèo', 'teo.nguyen26@gmail.com', '0987654326', NOW(), NOW(), 'customer'),
    (27, 'employee27', 'password27', 'active', 'Trần Thị Anh', 'anh.tran27@gmail.com', '0987654327', NOW(), NOW(), 'customer'),
    (28, 'employee28', 'password28', 'active', 'Lê Văn Dũng', 'dung.le28@gmail.com', '0987654328', NOW(), NOW(), 'customer'),
    (29, 'employee29', 'password29', 'active', 'Phạm Minh Quang', 'quang.pham29@gmail.com', '0987654329', NOW(), NOW(), 'customer'),
    (30, 'employee30', 'password30', 'active', 'Trần Ngọc Hà', 'ha.tran30@gmail.com', '0987654330', NOW(), NOW(), 'customer'),
    (31, 'employee31', 'password31', 'active', 'Nguyễn Thị Ngọc', 'ngoc.nguyen31@gmail.com', '0987654331', NOW(), NOW(), 'customer'),
    (32, 'employee32', 'password32', 'active', 'Phan Đình Tùng', 'tung.phan32@gmail.com', '0987654332', NOW(), NOW(), 'customer'),
    (33, 'employee33', 'password33', 'active', 'Lê Thị Ánh', 'anh.le33@gmail.com', '0987654333', NOW(), NOW(), 'customer'),
    (34, 'employee34', 'password34', 'active', 'Đỗ Thị Minh', 'minh.do34@gmail.com', '0987654334', NOW(), NOW(), 'customer'),
    (35, 'employee35', 'password35', 'active', 'Nguyễn Hoàng Long', 'long.nguyen35@gmail.com', '0987654335', NOW(), NOW(), 'customer'),
    (36, 'employee36', 'password36', 'active', 'Phạm Thị Diễm', 'diem.pham36@gmail.com', '0987654336', NOW(), NOW(), 'customer'),
    (37, 'employee37', 'password37', 'active', 'Trần Văn Hùng', 'hung.tran37@gmail.com', '0987654337', NOW(), NOW(), 'customer'),
    (38, 'employee38', 'password38', 'active', 'Nguyễn Minh Hiếu', 'hieu.nguyen38@gmail.com', '0987654338', NOW(), NOW(), 'customer'),
    (39, 'employee39', 'password39', 'active', 'Lê Thị Huyền', 'huyen.le39@gmail.com', '0987654339', NOW(), NOW(), 'customer'),
    (40, 'employee40', 'password40', 'active', 'Vũ Thị Hồng', 'hong.vu40@gmail.com', '0987654340', NOW(), NOW(), 'customer'),
    (41, 'customer1', 'password123', 'active', 'Nguyễn Văn Khánh', 'customer1@gmail.com', '0987654321', NOW(), NOW(), 'customer'),
    (42, 'customer2', 'password123', 'active', 'Nguyễn Thị Hà', 'customer2@gmail.com', '0123456789', NOW(), NOW(), 'customer'),
    (43, 'customer3', 'password123', 'active', 'Trần Đức Thắng', 'customer3@gmail.com', '0909090909', NOW(), NOW(), 'customer'),
    (44, 'customer4', 'password123', 'active', 'Lê Văn Minh', 'customer4@gmail.com', '0999999999', NOW(), NOW(), 'customer'),
    (45, 'customer5', 'password123', 'active', 'Nguyễn Thị Lan Anh', 'customer5@gmail.com', '0888888888', NOW(), NOW(), 'customer'),
    (46, 'customer6', 'password123', 'active', 'Phạm Thị Ngọc Anh', 'customer6@gmail.com', '0777777777', NOW(), NOW(), 'customer'),
    (47, 'customer7', 'password123', 'active', 'Nguyễn Hữu Đạt', 'customer7@gmail.com', '0666666666', NOW(), NOW(), 'customer'),
    (48, 'customer8', 'password123', 'active', 'Trần Văn Thanh', 'customer8@gmail.com', '0555555555', NOW(), NOW(), 'customer'),
    (49, 'customer9', 'password123', 'active', 'Nguyễn Thị Thảo', 'customer9@gmail.com', '0444444444', NOW(), NOW(), 'customer'),
    (50, 'customer10', 'password123', 'active', 'Lê Thị Thu', 'customer10@gmail.com', '0333333333', NOW(), NOW(), 'customer'),
    (51, 'customer11', 'password123', 'active', 'Võ Thành Trung', 'customer11@gmail.com', '0222222222', NOW(), NOW(), 'customer'),
    (52, 'customer12', 'password123', 'active', 'Đặng Trung Hiếu', 'customer12@gmail.com', '0111111111', NOW(), NOW(), 'customer'),
    (53, 'customer13', 'password123', 'active', 'Nguyễn Thị Hằng', 'customer13@gmail.com', '0777777777', NOW(), NOW(), 'customer'),
    (54, 'customer14', 'password123', 'active', 'Phạm Thị Thúy', 'customer14@gmail.com', '0666666666', NOW(), NOW(), 'customer'),
    (55, 'customer15', 'password123', 'active', 'Lê Thị Hoa', 'customer15@gmail.com', '0555555555', NOW(), NOW(), 'customer');




INSERT INTO `current_user_id` (`user_id`) VALUES (1);
