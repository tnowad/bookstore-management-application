...
public class ProfileSettings extends JPanel {
  ...
  private void initComponents() {
    ...
    getPhoneTxtFld.addActionListener(
      new ActionListener() {
    ...
    getUserNameTxtFld.addActionListener(
      new ActionListener() {
        public void actionPerformed(ActionEvent evt) {
    ...
    GroupLayout getInformationPanelLayout = new GroupLayout(
      getInformationPanel
    );
    ...
    updateUserInformationBtn.addActionListener(
      new ActionListener() {
        public void actionPerformed(ActionEvent evt) {
    ...
    resetUserInformation.addActionListener(
      new ActionListener() {
        public void actionPerformed(ActionEvent evt) {
    ...
    getZipTxtFld.addActionListener(
      new ActionListener() {
        public void actionPerformed(ActionEvent evt) {
    ...
    getStateTxtFld.addActionListener(
      new ActionListener() {
        public void actionPerformed(ActionEvent evt) {
