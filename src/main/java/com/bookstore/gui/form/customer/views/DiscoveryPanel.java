...
public class DiscoveryPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        sortByConditionComboBox.setModel(new DefaultComboBoxModel<>(
        ...
        sortByConditionComboBox.addActionListener(new ActionListener() {
        ...
        categoryListComboBox.setModel(new DefaultComboBoxModel<>(new String[] { "All" }));
        ...
        categoryListComboBox.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        searchTextField.addFocusListener((FocusListener) new FocusAdapter() {
        ...
        cartButtonTextField.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
