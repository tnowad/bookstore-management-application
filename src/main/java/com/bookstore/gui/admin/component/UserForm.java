...
public class UserForm extends javax.swing.JPanel implements MouseListener {
     ...
     */
    public UserForm(int Serial,int idUser,String userName,String password,Status status, String name, String email, String phone, Role role,Timestamp dateCreate,Timestamp dateUpdate) {
        initComponents(Serial, idUser, userName, password, status,  name,  email,  phone,  role);
        addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e){
                PopupUser userFullForm = new PopupUser(idUser, userName, password, status, name, email, phone, role,dateCreate,dateUpdate);
    ...
    private void initComponents(int Serial,int idUser,String userName,String password,Status status, String name, String email, String phone, Enum role ) {
