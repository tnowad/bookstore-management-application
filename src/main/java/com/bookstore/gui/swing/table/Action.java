...
public class Action extends javax.swing.JPanel {
  ...
  public Action(ModelAction data) {
    initComponents();
    cmdEdit.addActionListener(ae -> data.getEvent().update(data.getStudent()));
    cmdDelete.addActionListener(ae -> data.getEvent().delete(data.getStudent()));
  }
    ...
    layout.setHorizontalGroup(
        layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(cmdEdit, javax.swing.GroupLayout.PREFERRED_SIZE, 28,
                    javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cmdDelete, javax.swing.GroupLayout.PREFERRED_SIZE, 28,
                    javax.swing.GroupLayout.PREFERRED_SIZE)
  ...
  private com.bookstore.gui.swing.Button cmdDelete;
  private com.bookstore.gui.swing.Button cmdEdit;
