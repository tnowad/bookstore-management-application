...
public class PopupOrderFrame extends javax.swing.JFrame {
  ...
  private void initComponents(
    ...
    getNameCustomer.setText(
      UserBUS.getInstance().getModelById(idCustomer).getName()
    );
    ...
    getNameEmployee.setText(
      UserBUS.getInstance().getModelById(idEmployee).getName()
    );
    ...
    ButtonExportPDF.addActionListener(
      new ActionListener() {
        @Override
